...
const Hardware = () => {
  ...
  const images = [
    '/media/images/h01.png',
    '/media/images/h02.png',
    '/media/images/h03.png',
    '/media/images/h04.png',    
    '/media/images/h05.png',
    '/media/images/h06.png',
    '/media/images/h07.png',
  ];
      ...
      <div className="content-wrapper reverse-layout">
        ...
        <div className="text-content">
          <h2 className="subtitle-animation">
            <span className="gold-text">HARDWARE</span>
            <span className="underline-animation"></span>
          </h2>
          
          <div className="text-content-inner">
            <p className="animate-text floating-text">
              We provide top-quality hardware products including hinges, handles, locks, 
              and other essential fittings for doors, windows, and furniture.
            </p>
